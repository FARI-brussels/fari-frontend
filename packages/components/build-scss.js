...
const styleScssPath = 'node_modules/@fari/style/dist/sass/style.scss';
...
let combinedContent = '/* FARI Components - Combined SCSS (includes @fari/style) */\n\n';
combinedContent += `/* From @fari/style */\n${styleScssContent}\n\n`;
combinedContent += `/* From @fari/components */\n${componentsScssContent.replace(/@use 'style';/, '')}\n`;
